...
NCountry = {
	...
	CIRCUMNAVIGATION_PROVINCE_1 = 848,			-- Provinces for circumnavigation (coast of gambia)
	CIRCUMNAVIGATION_PROVINCE_2 = 849,			-- Provinces for circumnavigation (magellan strait)
	CIRCUMNAVIGATION_PROVINCE_3 = 850,			-- Provinces for circumnavigation (hawaii sea)
	CIRCUMNAVIGATION_PROVINCE_4 = 851,			-- Provinces for circumnavigation (hawaii sea)
	CIRCUMNAVIGATION_PROVINCE_5 = 852,			-- Provinces for circumnavigation (hawaii sea)
	CIRCUMNAVIGATION_PROVINCE_6 = 853,			-- Provinces for circumnavigation (cape of good hope)
	...
	PS_ESTABLISH_SIBERIAN_FRONTIER = 60, -- Rathnir, was 20 in basegame
...
NFrontend = {
	CAMERA_LOOKAT_X = 4180.0, 						-- Rotation point in main menu
	CAMERA_LOOKAT_Y = 0.0,
	CAMERA_LOOKAT_Z = 1148.0,
	CAMERA_LOOKAT_SETTINGS_X = 3980.0, 				-- Rotation point in settings
	CAMERA_LOOKAT_SETTINGS_Y = 0.0,					-- Y is height
	CAMERA_LOOKAT_SETTINGS_Z = 1198.0,
	CAMERA_START_X = 4080.0,						-- Initial position in main menu
	CAMERA_START_Y = 300,							-- Y is height
	CAMERA_START_Z = 1060.0,
	CAMERA_END_X = 3980.0,							-- Move to position in main menu
	CAMERA_END_Y = 900.0,
	CAMERA_END_Z = 1048.0,
